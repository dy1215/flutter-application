                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          leading: Icon(Icons.camera),
                          title: Text('Simple Card 2 in Stack'),
                          subtitle: Text('Eleavtion - 8'),
                        )
                      ),
                    ),
                    Padding(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          leading: Icon(Icons.album),
                          title: Text('Simple Card 3 in Stack'),
                          subtitle: Text('Eleavtion - 16'),
                        )
                      ),
                    ),
                    Padding(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          leading: Icon(Icons.album),
                          title: Text('Simple Card 4 in Stack'),
                          subtitle: Text('Eleavtion - 16'),
                        )
                      ),
                    ),
